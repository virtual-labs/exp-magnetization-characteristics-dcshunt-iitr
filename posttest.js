...
{
      question: "The voltage drop in terminal voltage from no-load to full load in a shunt generator can be compenated using ____.",  ///// Write the question inside double quotes
      answers: {
        a: "long-shunt, differential field",                  ///// Write the option 1 inside double quotes
        b: "aiding shunt field",                  ///// Write the option 2 inside double quotes
        c: "aiding series field",                  ///// Write the option 3 inside double quotes
        d: "None of the above"                   ///// Write the option 4 inside double quotes
      },
      correctAnswer: "c"                ///// Write the correct option inside double quotes
    },  
    ...
    {
      question: "If the speed of a DC machine is doubled and the flux remains a constant, the generated e.m.f....",  ///// Write the question inside double quotes
      answers: {
        a: "remains the same",                  ///// Write the option 1 inside double quotes
        b: "is doubled",                  ///// Write the option 2 inside double quotes
        c: "is halved",                  ///// Write the option 3 inside double quotes
        d: "None of the above"                   ///// Write the option 4 inside double quotes
      },
